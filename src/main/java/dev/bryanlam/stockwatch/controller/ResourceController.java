...
import dev.bryanlam.stockwatch.dto.SearchStockDTO;
...
public class ResourceController {
    ...
    @Autowired
    public ResourceController(UserServiceImpl userService, StockServiceImpl stockService, AlertServiceImpl alertService) {
